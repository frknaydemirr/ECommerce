...
namespace ECommerce.Data.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // Seed data statik değerlerle
            migrationBuilder.InsertData(
                table: "AppUsers",
                columns: new[] { "Id", "CreateDate", "Email", "Name", "Password", "Phone", "SurName", "UserGuid", "UserName", "isActive", "isAdmin" },
                values: new object[] { 1, new DateTime(2025, 9, 19, 0, 0, 0, DateTimeKind.Unspecified), "admin@gmail.com", "Test", "123456*", null, "User", Guid.Parse("5f727bf4-0540-4b5b-85be-8ae9f3ce1f33"), "Admin", true, true });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 9, 19, 0, 0, 0, DateTimeKind.Unspecified), null, null, true, true, "Elektronik", 1, 0 },
                    { 2, new DateTime(2025, 9, 19, 0, 0, 0, DateTimeKind.Unspecified), null, null, true, true, "Bilgisayar", 2, 0 }
                });
